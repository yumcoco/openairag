...
function loadRagOptions() {
    ...
    fetch('http://188.245.233.12:8090/api/v1/rag/query_rag_tag_list')
...
function startEventStream(message) {
    ...
    let url;
    if (ragTag) {
        url = `http://188.245.233.12:8090/api/v1/${aiModelValue}/generate_stream_rag?message=${encodeURIComponent(message)}&ragTag=${encodeURIComponent(ragTag)}&model=${encodeURIComponent(aiModelModel)}`;
    } else {
        url = `http://188.245.233.12:8090/api/v1/${aiModelValue}/generate_stream?message=${encodeURIComponent(message)}&model=${encodeURIComponent(aiModelModel)}`;
    }
